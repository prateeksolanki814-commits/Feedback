...
def show_feedback_form():
    ...
    st.markdown("Please share your shopping experience with us.")
    ...
    with st.form("feedback_form"):
        ...
        with col1:
            ...
            store_visit_date = st.date_input("📅 Visit Date")
        ...
        with col2:
            ...
            comments = st.text_area("Share your experience", placeholder="Tell us what you liked...", height=120)
        ...
        if submitted:
            if rating is None:
                ...
                add_feedback(customer_name if customer_name else "Anonymous", rating, category, comments, store_visit_date.strftime("%Y-%m-%d"), contact_info)
